package com.knoor.soft.service.impl;
...
//
//	@Override
//	public BookCollection create(BookCollection toPersist) throws  BusinessException {
//		try {
...
//
//	@Override
//	public void update(BookCollection book) throws  BusinessException {
//		Query q = new Query();
...
//
//	@Override
//	public BookCollection findById(String bookId) throws  BusinessException {
//		return mongoTemplate.findById(bookId, BookCollection.class);
//	}
//
//	@Override
//	public void remove(BookCollection book) throws  BusinessException {
//		mongoTemplate.remove(book, BookCollection.class.getSimpleName());
//
//	}
//
//	@Override
//	public List<BookCollection> findByCriteria(List<QueryParam> qp) throws BusinessException {
//		
...
//
//	@Override
//	public List<BookCollection> findAll() throws  BusinessException {
...
//
//	@Override
//	public void removeAll(List<BookCollection> collections) throws  BusinessException {
//
//		try {
